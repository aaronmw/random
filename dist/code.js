...
/* harmony import */ var lodash_random__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lodash/random */ "./node_modules/lodash/random.js");
/* harmony import */ var lodash_random__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lodash_random__WEBPACK_IMPORTED_MODULE_5__);
...
const transformProp = ({ node, propConfig, propName }) => __awaiter(undefined, void 0, void 0, function* () {
    ...
    switch (method) {
        case 'range':
            ...
            randomValue = lodash_random__WEBPACK_IMPORTED_MODULE_5___default()(rangeMin, rangeMax);
        ...
        case 'calc':
            ...
            const currentPropValue = propName === 'text'
                ? toInteger(lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(node.characters.match(/[0-9,]+(\.[0-9]+)?/), '0', 0).replace(/,/g, ''))
                : node[propName];
            randomValue = lodash_random__WEBPACK_IMPORTED_MODULE_5___default()(calcMin, calcMax);
            newPropValue =
            ...
            break;
        case 'list':
            randomValue = lodash_sample__WEBPACK_IMPORTED_MODULE_6___default()(propConfig['list']);
            newPropValue = randomValue;
            break;
    }
    switch (propName) {
        ...
        case 'height':
            ...
            break;
        case 'layerBlur':
            const effects = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.effects);
            effects[0] = {
                type: 'LAYER_BLUR',
            ...
            break;
        case 'fillColor':
            const fillsForColor = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.fills);
            fillsForColor[0].color = toColor(newPropValue);
            node.fills = fillsForColor;
            break;
        case 'strokeColor':
            const strokesForColor = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.strokes);
            strokesForColor[0].color = toColor(newPropValue);
            node.strokes = strokesForColor;
            break;
        case 'fillOpacity':
            const fillsForOpacity = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.fills);
            fillsForOpacity[0].opacity = toPercentage(newPropValue);
            node.fills = fillsForOpacity;
            break;
        case 'strokeOpacity':
            const strokesForOpacity = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.strokes);
            strokesForOpacity[0].opacity = toPercentage(newPropValue);
            node.strokes = strokesForOpacity;
            break;
        case 'arcStartingAngle':
            const arcDataForStartingAngle = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.arcData);
            arcDataForStartingAngle.startingAngle = toDegrees(newPropValue);
            node.arcData = arcDataForStartingAngle;
            break;
        case 'arcEndingAngle':
            const arcDataForEndingAngle = lodash_cloneDeep__WEBPACK_IMPORTED_MODULE_1___default()(node.arcData);
...
figma.ui.onmessage = (msg) => __awaiter(undefined, void 0, void 0, function* () {
    if (msg.type === 'init') {
        ...
        lodash_mergeWith__WEBPACK_IMPORTED_MODULE_4___default()(newState, msg.initialState, savedState, (objValue, srcValue) => {
            if (lodash_isArray__WEBPACK_IMPORTED_MODULE_3___default()(objValue) && lodash_isArray__WEBPACK_IMPORTED_MODULE_3___default()(srcValue)) {
                return srcValue;
            }
        });
    ...
    if (msg.type === 'run') {
        ...
        if (selectedNodes.length === 0) {
            ...
            figma.notify(`You have nothing selected, but here's a random thing anyway: ${lodash_sample__WEBPACK_IMPORTED_MODULE_6___default()(RANDOM_THINGS)}`);
            return;
        }
        ...
        Object.keys(config).map(propName => {
            ...
            if (propConfig.isActive) {
                selectedNodes.map((node) => __awaiter(this, void 0, void 0, function* () {
                    yield transformProp({
                        node,
                        propConfig,
                        propName,
